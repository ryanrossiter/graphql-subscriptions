...
var testFiniteAsyncIterator = iterall_1.createAsyncIterator([1, 2, 3, 4, 5, 6, 7, 8]);
...
describe('withFilter', function () {
    it('works properly with finite asyncIterators', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filteredAsyncIterator = with_filter_1.withFilter(function () { return testFiniteAsyncIterator; }, isEven)();
                    i = 1;
                    _a.label = 1;
                case 1:
                    if (!(i <= 4)) return [3, 4];
                ...
                case 3:
                    i++;
                    return [3, 1];
                case 4: return [4, filteredAsyncIterator.next()];
                case 5:
                    doneResult = _a.sent();
